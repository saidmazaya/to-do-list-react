...
function App() {
  ...
  const [toDo, setToDo] = useState(getInitialActivities());
  ...
  return (
    <div className="container App">
      ...
      {updateData && updateData ? <UpdateForm updateData={updateData} changeTask={changeTask} updateTask={updateTask} cancelUpdate={cancelUpdate} /> : <AddTaskForm newTask={newTask} setNewTask={setNewTask} addTask={addTask} />}
